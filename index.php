...
<?php
include_once('daryeel/include/config.php');
...
<head>
  ...
  <title>Daryeel - Homepage</title>
  <link rel="shortcut icon" href="assets/images/doctor.jpg" type="image/png">
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12 geele" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">
                    ...
                    <div class="col-sm-2 d-none d-lg-block appoint">
                        <a class="btn btn-success" href="daryeel/user-login.php">Book an Appointment</a>
                    </div>
                </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active ">
                    <img class="d-block w-100" src="assets/images/slider/slider_1.jpg" alt="Second slide">
                    <!-- <div class="carousel-cover"></div> -->
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown" style="color:black ">Daryeel Dental Clinic Management System</h5>
                ...
                <!-- <div class="carousel-item ">
                    <img class="d-block w-100" src="assets/images/slider/slider_5.jpg" alt="Third slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Daryeel Appointmet managment system</h5>
                ...
                <div class="row no-margin">
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Patient Login</h6>
                                <a href="daryeel/user-login.php" target="_blank">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Doctors login</h6>
                                <a href="daryeel/doctor" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                ...
                                <a href="daryeel/admin" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
...
?>
    ...
    <div class="copy">
            <div class="container">
        <center>Daryeel appointment Management System</center> 
